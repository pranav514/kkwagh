...
function CalendarPopup() {
	...
	c.monthAbbreviations = new Array("01","02","03","04","05","06","07","08","09","10","11","12");
...
function CP_getCalendar() {
	...
	if (this.displayType=="date" || this.displayType=="week-end") {
		...
		var date_class;
		if (this.type!="WINDOW") {
			result += "<TABLE WIDTH=175 BORDER=0 BORDERWIDTH=0 CELLSPACING=0 CELLPADDING=0>";
			}
		result += '<TR>\n';
		var refresh = windowref+'CP_refreshCalendar';
		var refreshLink = 'javascript:' + refresh;
		if (this.isShowNavigationDropdowns) {
			result += '<TD CLASS="'+this.cssPrefix+'cpMonthNavigation" HEIGHT="30" align="center"><select CLASS="'+this.cssPrefix+'cpMonthNavigation" name="cpMonth" onChange="'+refresh+'('+this.index+',this.options[this.selectedIndex].value-0,'+(year-0)+');">';
			...
			for( var yearCounter=1900; yearCounter<=year+3; yearCounter++ ) {
